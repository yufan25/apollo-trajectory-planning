...
c_int osqp_setup(OSQPWorkspace* work, const OSQPData *data, const OSQPSettings *settings) {
  ...
  // work = (OSQPWorkspace *) c_calloc(1, sizeof(OSQPWorkspace));
  if (!(work)) return osqp_error(OSQP_MEM_ALLOC_ERROR);
  // *workp = work;

  // Start and allocate directly timer
# ifdef PROFILING
  work->timer = (OSQPTimer *)c_malloc(sizeof(OSQPTimer));
  if (!(work->timer)) return osqp_error(OSQP_MEM_ALLOC_ERROR);
  osqp_tic(work->timer);
# endif /* ifdef PROFILING */

  // Copy problem data into workspace
  work->data = (OSQPData *) c_malloc(sizeof(OSQPData));
  ...
  work->rho_vec     = (c_float *) c_malloc(data->m * sizeof(c_float));
  work->rho_inv_vec = (c_float *) c_malloc(data->m * sizeof(c_float));
  if ( data->m && (!(work->rho_vec) || !(work->rho_inv_vec)) )
    return osqp_error(OSQP_MEM_ALLOC_ERROR);

  // Type of constraints
  work->constr_type = (c_int *) c_calloc(data->m, sizeof(c_int));
  if (data->m && !(work->constr_type)) return osqp_error(OSQP_MEM_ALLOC_ERROR);

  // Allocate internal solver variables (ADMM steps)
  work->x        = (c_float *) c_calloc(data->n, sizeof(c_float));
  work->z        = (c_float *) c_calloc(data->m, sizeof(c_float));
  work->xz_tilde = (c_float *) c_calloc(data->n + data->m, sizeof(c_float));
  work->x_prev   = (c_float *) c_calloc(data->n, sizeof(c_float));
  work->z_prev   = (c_float *) c_calloc(data->m, sizeof(c_float));
  work->y        = (c_float *) c_calloc(data->m, sizeof(c_float));
  ...
  work->Ax  = (c_float *) c_calloc(data->m, sizeof(c_float));
  work->Px  = (c_float *) c_calloc(data->n, sizeof(c_float));
  work->Aty = (c_float *) c_calloc(data->n, sizeof(c_float));

  // Primal infeasibility variables
  work->delta_y   = (c_float *) c_calloc(data->m, sizeof(c_float));
  work->Atdelta_y = (c_float *) c_calloc(data->n, sizeof(c_float));

  // Dual infeasibility variables
  work->delta_x  = (c_float *) c_calloc(data->n, sizeof(c_float));
  work->Pdelta_x = (c_float *) c_calloc(data->n, sizeof(c_float));
  work->Adelta_x = (c_float *) c_calloc(data->m, sizeof(c_float));
  ...
  if (settings->scaling) {
    ...
    work->scaling = (OSQPScaling *) c_malloc(sizeof(OSQPScaling));
    if (!(work->scaling)) return osqp_error(OSQP_MEM_ALLOC_ERROR);
    work->scaling->D    = (c_float *) c_malloc(data->n * sizeof(c_float));
    work->scaling->Dinv = (c_float *) c_malloc(data->n * sizeof(c_float));
    work->scaling->E    = (c_float *) c_malloc(data->m * sizeof(c_float));
    work->scaling->Einv = (c_float *) c_malloc(data->m * sizeof(c_float));
    ...
    work->D_temp   = (c_float *) c_malloc(data->n * sizeof(c_float));
    work->D_temp_A = (c_float *) c_malloc(data->n * sizeof(c_float));
    work->E_temp   = (c_float *) c_malloc(data->m * sizeof(c_float));
  ...
  work->pol = (OSQPPolish *) c_malloc(sizeof(OSQPPolish));
  if (!(work->pol)) return osqp_error(OSQP_MEM_ALLOC_ERROR);
  work->pol->Alow_to_A = (c_int *) c_malloc(data->m * sizeof(c_int));
  work->pol->Aupp_to_A = (c_int *) c_malloc(data->m * sizeof(c_int));
  work->pol->A_to_Alow = (c_int *) c_malloc(data->m * sizeof(c_int));
  work->pol->A_to_Aupp = (c_int *) c_malloc(data->m * sizeof(c_int));
  work->pol->x         = (c_float *) c_malloc(data->n * sizeof(c_float));
  work->pol->z         = (c_float *) c_malloc(data->m * sizeof(c_float));
  work->pol->y         = (c_float *) c_malloc(data->m * sizeof(c_float));
  ...
  work->solution->x = (c_float *) c_calloc(1, data->n * sizeof(c_float));
  work->solution->y = (c_float *) c_calloc(1, data->m * sizeof(c_float));
