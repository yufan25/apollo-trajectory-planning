...
DiscretizedTrajectory TrajectoryCombiner::Combine(
  ...
  while (t_param < FLAGS_trajectory_time_length) {
    ...
    if (prev_trajectory_point.x>-255 && prev_trajectory_point.y>-255) {
    ...
    trajectory_point.path_point.set_x(x);
    trajectory_point.path_point.set_y(y);
    trajectory_point.path_point.set_s(accumulated_trajectory_s);
    trajectory_point.path_point.set_theta(theta);
    trajectory_point.path_point.set_kappa(kappa);
